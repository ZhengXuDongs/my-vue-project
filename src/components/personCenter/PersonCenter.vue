<template>
  ...
  <div id="vue-img-uploader">
	    ...
	    <label :for="componentId" class="up_label"
	...
	<div class="person_content">
		<div class="person_content_item">
			<label class="item_lable">账号：</label><p>顾沉舟</p>
		</div>
	    <div class="person_content_item">
			<label class="item_lable">accountId：</label><p>12345689</p>
		</div>
		<div class="person_content_item">
			<label class="item_lable">电话：</label><p>13594100693</p>
		</div>
		<div class="person_content_item">
			<label class="item_lable">性别：</label><p>女</p>
		</div>
		<div class="person_content_item">
			<label class="item_lable">联系地址：</label><p>重庆市渝北区</p>
		</div>
		<div class="person_content_item">
			<label class="item_lable">email：</label><p>12356981@qq.com</p>
		</div>
	</div>
  </div>
</template>
